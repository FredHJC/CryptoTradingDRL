#    Developed based on FinRL source code
#    Date: 12/20/2021
#    Availability: https://github.com/AI4Finance-Foundation/FinRL-Meta/blob/master/finrl_meta/data_processors/processor_binance.py
